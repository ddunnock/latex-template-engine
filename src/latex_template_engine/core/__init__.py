...
Components:
    TemplateEngine: Main engine class that orchestrates template operations
    Template: Individual template wrapper with metadata and rendering capabilities

The core module is designed to be independent of CLI or editor integrations,
making it suitable for embedding in other applications or using programmatically.
"""
...
# Define what gets imported when using 'from latex_template_engine.core import *'
